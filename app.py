...
<style>
    ...
    .splash-container {{ padding: 0 !important; margin: 0 !important; max-width: none !important; height: 100vh;
                       ...
                       background-image: url('{splash_bg_url}');
...
if ss.step == 0:
    # Apply body class for splash
    st.markdown('<body class="splash-body">', unsafe_allow_html=True)
    ...
    # Remove body class after render (hacky, might not be needed if rerun works fast)
