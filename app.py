...
# Inject CSS globally (moved outside conditional logic)
...
<style>
    ...
    /* Target the container Streamlit creates for st.markdown when step is 0 */
    div[data-testid="stAppViewContainer"] > section > div.block-container {{
         ...
         background-image: {'url("'+splash_bg_url+'")' if ss.step == 0 else 'none'};
